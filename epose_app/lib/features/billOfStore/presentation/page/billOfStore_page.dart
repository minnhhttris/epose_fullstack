...
import '../controller/billOfStore_controller.dart';
import '../widgets/billOfStore_appbar_widget.dart';
import '../widgets/billOfStore_card_widget.dart';

class BillOfStorePage extends GetView<BillOfStoreController> {
  const BillOfStorePage({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const BillOfStoreAppbar(),
      body: Column(
        children: [
          tabState(),
          listBill(),
